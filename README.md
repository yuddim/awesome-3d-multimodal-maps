...
(2024) **Mapping the Unseen: Unified Promptable Panoptic Mapping with Dynamic Labeling using Foundation Models.** arXiv preprint arXiv:2405.02162. Mdfaa, M.A., Salameh, R., Zagoruyko, S. and Ferrer, G. (SkolTech) [(paper)](https://arxiv.org/abs/2405.02162) | [(code is coming soon)]() | [(project)](https://unified-promptable-panoptic-mapping.github.io)  
